...
const PromptNodeAdd = (props: {
    ...
    const handlePromptNodeSelection = useCallback((event: ChangeEvent<HTMLSelectElement>) => {
        setSelectedNodeName(event?.target?.value ?? undefined)
    }, [setSelectedNodeName])
    ...
    return <Flex gap={2} direction="column">
        ...
        <Button size="md" onClick={handlePromptNodeAdd}>Add Node</Button>
    </Flex>
}
